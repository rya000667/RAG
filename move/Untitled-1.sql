/*
Musical Track Database plus Artists Assignment
*/
...
UPDATE tracktoartist SET track_id = track.id FROM track WHERE tracktoartist.track = track.title;
UPDATE tracktoartist SET artist_id = artist.id FROM artist WHERE tracktoartist.artist = artist.name;
